...
class ObligationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create obligation" do
    assert_difference('Obligation.count') do
      post obligations_url, params: { obligation: { state: @obligation.state, template_id: @obligation.template_id } }
    end
  ...
  test "should update obligation" do
    patch obligation_url(@obligation), params: { obligation: { state: @obligation.state, template_id: @obligation.template_id } }
